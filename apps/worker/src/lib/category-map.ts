...
const NAME_RULES: CategoryRule[] = [
  ...
  // ─────────────────────────────────────────────────────────
  // Correcciones 2026-09: productos que caían en el bucket default
  // 'almacen' (o en 'frescos') por falta de regla específica.
  // Deben ir ANTES de los prefijos genéricos de sub-categorías.
  // ─────────────────────────────────────────────────────────
  {
    categoryPath: 'almacen/chocolates',
    prefixes: [
  ...
  { categoryPath: 'almacen/aceite', prefixes: ['vinagre', 'vinagres', 'aceto'] },
  {
  ...
  { categoryPath: 'almacen/arroz', prefixes: ['risotto', 'gallo risotto', 'arroz risotto'] },
  {
  ...
  {
    categoryPath: 'almacen/conservas',
    prefixes: ['choclo en lata', 'choclo entero en lata', 'choclo blanco', 'choclo desgranado'],
  },
  {
  ...
  {
    categoryPath: 'lacteos/leches',
    prefixes: ['crema de leche', 'crema leche', 'sachet leche', 'leche cremada'],
  },
  {
    categoryPath: 'perfumeria/pañales',
    prefixes: ['leche infantil', 'leche materna', 'leche maternizada'],
  },
  { categoryPath: 'lacteos/yogures', prefixes: ['sachet yogur', 'yogurisimo'] },
  { categoryPath: 'lacteos/dulce-de-leche', prefixes: ['dulce leche'] },
  {
  ...
  { categoryPath: 'perfumeria', prefixes: ['colonia', 'perf ', 'protectores diarios', 'wipes'] },
  {
    categoryPath: 'limpieza/detergentes',
    prefixes: [
      'winny espuma',
...
const STORE_ALIASES: Array<{ path: string; tokens: string[] }> = [
  ...
  { path: 'almacen/sopas', tokens: ['sopas', 'sopa', 'caldos', 'caldo', 'ramen', 'salteados'] },
