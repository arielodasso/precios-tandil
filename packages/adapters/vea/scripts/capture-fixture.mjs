/**
 * Captura y congela un fixture estructural del caché Apollo (VTEX IO) de Vea.
 *
 * Uso: node scripts/capture-fixture.mjs
 * Regenera tests/fixtures/vea-listing-arroz.html a partir de la página real.
 */
...
const SOURCE_URL = 'https://www.vea.com.ar/almacen/arroz-y-legumbres/arroz';
const OUTPUT = join(__dirname, '..', 'tests', 'fixtures', 'vea-listing-arroz.html');
const UA =
...
async function main() {
  ...
  const title = html.match(/<title>([^<]*)<\/title>/)?.[1] ?? 'Vea';
